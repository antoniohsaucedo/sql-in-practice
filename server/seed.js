...
const sequelize = new Sequelize(CONNECTION_STRING, {
  ...
  module.exports = {
    seed: (req, res) => {
        ...
        values (2, '2021-05-04T11:00:00.000Z', 'tree trimming', '', false, false),
            (3, '2021-06-16T12:30:00.000Z', 'sprinklers', 'Fixed sprinkler head in northeast corner of the backyard', true, false),
